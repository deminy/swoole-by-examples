...
<?php
/**
 * In this example, we set PHP option "swoole.enable_preemptive_scheduler" to 1 at line 11, allowing different
 ...
 *     docker exec -t  $(docker ps -qf "name=server") bash -c "./csp/scheduling/mixed.php"
 */
